...
public class CompanyDao implements DaoModel {

	public final static String DB			= "mvest";
	public final static String TABLE		= "m1_company ";
	public final static String[] COLUMNS  	= {"co_id", "co_code", "co_name"};
	
	public volatile static CompanyDao instance;
	
	public synchronized  static CompanyDao getInstace(){
		if(instance == null){
...
/*		// TODO Auto-generated method stub
	...
	public List getList(int start, int offset, String where, String orderby) throws Exception {
		...
		else query.setOrder("co_id", "DESC");
