...
public class LotteryDao implements DaoModel {

	public final static String DB			= "lottery";
	public final static String TABLE		= "win ";
	public final static String[] COLUMNS  	= {"round","n1", "n2", "n3","n4","n5","n6","b1","date"};
	
	public volatile static LotteryDao instance;
	
	public synchronized  static LotteryDao getInstace(){
		if(instance == null){
			synchronized(LotteryDao.class){
...
/*		// TODO Auto-generated method stub
	...
	public Object selectLast() throws Exception {
		...
		// TODO Auto-generated method stub
				...
				win.setDate(obj[0][8].toString());
				win.setReg_date(obj[0][8].toString());
	...
	public List getList(int start, int offset, String where, String orderby) throws Exception {
		...
		else query.setOrder("round", "DESC");
