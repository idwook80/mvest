...
import com.mvest.m.mystock.action.*;
...
public class MyStockServlet extends ServletModel {
	private static final long serialVersionUID = 1L;
	public static final Logger LOG			= Logger.getLogger(MyStockServlet.class);
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MyStockServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
		setCommand("/mystock/", request, response);
	...
	public void listAction(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		MyStockListAction action = new MyStockListAction();
